...
#option #1 how to put a constraint and !=
        COORD_X=COORD_X-DELTA_STEP
    if keys[pygame.K_RIGHT]:
#option #2 how to put a constraint
        if COORD_X - DELTA_STEP >0:
            continue
            COORD_X = WIDTH_DISPLAY
        COORD_X=COORD_X+DELTA_STEP
#option 3 how to put a constraint
    ...
    pygame.draw.rect(gameDisplay, (255,0,0), [COORD_X, COORD_Y, 
                                        WIDTH_RECTANGLE, 
                                        HEIGHT_RECTANGLE])

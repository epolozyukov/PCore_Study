...
try:
    player_image = pygame.image.load(r"C:\Users\yevhen.poloziukov\Desktop\PCORE\HomeTasks\8\1_2.png").convert()
    back_image = pygame.image.load(r"C:\Users\yevhen.poloziukov\Desktop\PCORE\HomeTasks\8\1_1.png").convert()
except:
